    ...
    <div className="flex flex-col gap-6">
      <SectionFrame>
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-[0.3em] text-noir-500">Configurações</p>
          <h1 className="font-display text-3xl text-noir-950">Ajustes institucionais</h1>
      ...
      <SectionFrame>
        ...
        <div className="mt-4 space-y-3">
          {settings.map((row) => (
            ...
            >
              <div>
                <p className="text-xs uppercase tracking-[0.3em] text-noir-500">{row.key}</p>
                <p className="text-sm text-noir-900">{row.value}</p>
              </div>
          ...
          {settings.length === 0 && (
            <p className="text-sm text-noir-600">Nenhuma configuração registrada.</p>
          )}
        </div>
      </SectionFrame>
    </div>
