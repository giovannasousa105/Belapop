    ...
    <div className="flex flex-col gap-6">
      <SectionFrame>
        <div className="space-y-2">
          ...
          <h1 className="font-display text-3xl text-bpBlack">Curadoria BelaPop</h1>
      ...
      <SectionFrame>
        <div className="space-y-4">
          {products.map((product) => (
            ...
            >
              <div>
                ...
                <p className="text-xs text-bpGraphite/70">{formatPrice(product.price_cents)}</p>
          ...
          {products.length === 0 && (
            <p className="text-sm text-bpGraphite/80">Não há produtos para analisar.</p>
          )}
        </div>
      </SectionFrame>
    </div>
