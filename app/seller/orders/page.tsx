        ...
        <div className="grid gap-4">
          {rows.map((row) => (
            ...
            >
              ...
              <div className="mt-4 border-t border-black/10 pt-4 text-sm text-bpGraphite/80">
                <p className="text-xs uppercase tracking-[0.3em] text-bpGraphite/70">
                  Produtos
                </p>
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-3 text-xs text-bpGraphite/70">
                  <span>Frete: {row.shippingService}</span>
                  <span>{formatPrice(row.shippingValue)}</span>
                </div>
                <div className="mt-3 flex flex-wrap items-center justify-between gap-3 text-xs text-bpGraphite/70">
                  <span>
