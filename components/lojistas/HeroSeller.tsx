  ...
  return (
    <section className="bg-white">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 px-6 py-16 lg:grid lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          <div className="flex items-center gap-2 text-xs uppercase tracking-[0.3em] text-bpGraphite/70">
            <Sparkles size={14} className="text-bpPink" />
            Plataforma institucional
          </div>
          <h1 className="mt-5 font-display text-4xl text-bpBlack md:text-5xl">
            Plataforma institucional da BelaPop para marcas selecionadas.
          </h1>
          <p className="mt-5 text-base text-bpGraphite/80">
          ...
          <div className="mt-8 flex flex-wrap gap-3 text-xs text-bpGraphite/80">
            {highlights.map((item) => (
              <span
                key={item}
