...
const desktopNavItems = [
  ...
  { label: "Skin Scan Bela", href: "/skin-scan", accent: true }
] as const;
...
const mobileMenuItems = [
  ...
  { label: "Diário BelaPop", href: "/diario" },
...
const popClubMenuItems = [
  {
    eyebrow: "Comece aqui",
    label: "Manifesto PopClub",
    href: popClubPaths.landing,
    description: "Beneficios, membership e toda a porta de entrada do clube premium."
  },
  {
    eyebrow: "Membership",
    label: "Ativar assinatura",
    href: popClubPaths.membership,
    description: "Entre no ecossistema premium e libere a jornada completa."
  },
  {
    eyebrow: "Acesso antecipado",
    label: "Radar de drops",
    href: popClubPaths.radar,
    description: "Veja os produtos que podem chegar antes de todos."
  },
  {
    eyebrow: "Skin Scan + Clube",
    label: "Rotina personalizada",
    href: popClubPaths.routine,
    description: "Transforme o diagnostico em uma rotina editorial e guiada."
  }
] as const;
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-3 max-w-[22ch] text-sm leading-relaxed text-white/85">
                    Membership, radar de drops, rotina personalizada e acesso antecipado.
                  </p>
                </div>
        ...
        <section className="relative flex min-h-[calc(100svh-4rem)] items-end overflow-hidden bg-[#f6f3f2] md:items-center">
          <div className="absolute inset-0">
            ...
            >
              ...
              <img
                ...
                alt="Close-up de textura de pele em atmosfera editorial"
                className="h-full w-full object-cover"
              />
            </video>
          ...
          <div className="relative z-10 mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
            <div className="max-w-4xl">
              ...
              <p className="mt-6 max-w-md text-base leading-7 text-white/95 sm:text-lg">
                Uma abordagem consciente para a beleza que celebra a textura natural e o brilho
                autêntico.
              </p>
        ...
        <section className="bg-[#fcf9f8] px-4 py-20 sm:px-6 lg:px-8 lg:py-32">
          <div className="mx-auto max-w-4xl text-center">
            <div className="space-y-6">
              ...
              <p className="mx-auto max-w-2xl text-lg leading-relaxed text-[#444748] opacity-80">
                Nossa tecnologia exclusiva analisa as necessidades únicas da sua derme em
                segundos, recomendando uma rotina personalizada de alta performance.
              </p>
            </div>
            ...
            <div className="relative mx-auto mt-14 max-w-2xl">
              <div className="aspect-[3/4] overflow-hidden bg-[#f6f3f2]">
                <img
                  ...
                  alt="Retrato editorial focado em textura de pele"
            ...
            <div className="order-2 flex flex-col justify-center space-y-8 lg:order-1 lg:col-span-5 lg:space-y-12">
              <div className="space-y-5">
                ...
                <h2 className="font-headline text-4xl leading-none tracking-[-0.05em] text-[#1c1b1b] sm:text-5xl xl:text-7xl">
                  Soro Regenerador Orquídea Imperial
                </h2>
              ...
              <div className="max-w-md space-y-7">
                <p className="font-headline text-2xl italic leading-relaxed text-[#444748]">
                  &ldquo;O segredo da regeneração celular transformado em uma experiência sensorial
                  absoluta.&rdquo;
                </p>
                <p className="text-base leading-relaxed text-[#444748]/90">
                  Desenvolvido com extratos moleculares de orquídeas raras, este soro redefine o
                  contorno facial e restaura a luminosidade perdida em apenas 7 dias de uso
                  contínuo.
                </p>
            ...
            <div className="order-1 relative flex justify-end lg:order-2 lg:col-span-7">
              <div className="relative w-full max-w-2xl overflow-hidden bg-white shadow-2xl">
                <img
                  ...
                  alt="Frasco premium de serum em composicao minimalista"
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-14 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
              <div className="space-y-4">
                ...
                <h3 className="font-headline text-4xl text-black">Curadoria de Luxo</h3>
              </div>
              <Link
                href="/skincare"
                ...
                <div className="flex h-full flex-col justify-between gap-8">
                  <div>
                    ...
                    <h4 className="font-headline text-3xl leading-tight text-black sm:text-4xl">
                      A Ciência por trás das Orquídeas Imperiais.
                    </h4>
                  ...
                  <img
                    ...
                    alt="Close de uma orquidea branca rara"
              ...
              <div className="flex flex-col gap-8 lg:col-span-5">
                <article className="flex-1 bg-black p-8 text-white sm:p-10">
                  <h4 className="font-headline text-2xl leading-tight sm:text-3xl">
                    Tendências Inverno 2026: O Retorno do Brilho Natural.
                  </h4>
                  <Link
                    href="/diario"
                ...
                <Link href="/diario" className="group relative block min-h-[320px] overflow-hidden">
                  <img
                    ...
                    alt="Modelo em composicao editorial com joias e maquiagem"
                    className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-black/40" />
                  <div className="absolute inset-0 flex items-center justify-center p-8">
                    <h4 className="text-center font-headline text-2xl text-white">
                      Entrevista: O Ritual Noturno de Sofia Loren.
                    </h4>
                  </div>
                </Link>
              </div>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-6">
            ...
            <p className="max-w-xs font-body text-[10px] uppercase tracking-[0.18em] leading-relaxed text-gray-400">
              Elevando os padrões de autocuidado através da ciência e do luxo. Sua beleza é nossa
              maior curadoria.
            </p>
