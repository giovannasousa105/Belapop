...
type OrderPreviewScreenProps = {
  mode?: BelapopRenderMode;
};

export function OrderPreviewScreen({ mode = "preview" }: OrderPreviewScreenProps) {
  return (
      ...
      <main className="min-h-screen pt-20">
        <section className="relative w-full overflow-hidden">
          <div className="h-[340px] w-full sm:h-[420px] lg:h-[614px]">
            <img
              alt="Luxury beauty product arrangement"
          ...
          <div className="absolute bottom-0 left-0 z-10 w-full px-4 sm:px-6 lg:px-10">
            <div className="-mb-16 ml-0 max-w-2xl bg-[#fcf9f8] p-6 shadow-sm sm:-mb-20 sm:p-8 lg:-mb-24 lg:ml-8 lg:p-12">
              <h1
                className={`${previewHeadlineFont.className} text-4xl font-bold leading-none tracking-[-0.05em] text-[#1c1b1b] sm:text-5xl lg:text-7xl`}
              >
            ...
            <section className="space-y-8 sm:space-y-10 lg:space-y-12">
              ...
              <div className="flex flex-col gap-8 bg-[#f6f3f2] p-6 sm:p-8 lg:flex-row lg:items-center lg:gap-12 lg:p-12">
                ...
                <div className="flex-1 space-y-4 text-center lg:text-left">
                  <h3 className={`${previewHeadlineFont.className} text-3xl italic sm:text-4xl`}>
                    Creme de la Mer
                  </h3>
            ...
            <section className="space-y-8">
              ...
              <div className="space-y-6 bg-black p-6 text-white sm:p-8 lg:p-12">
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                  <Link
                    href={getBelapopHref(mode, "tracking")}
                    className={`${previewAccentButtonClass} text-center`}
                  >
                    Rastrear Entrega
                  </Link>
                  <Link
          ...
          <div className="space-y-10 lg:col-span-5 lg:space-y-16">
            <section className="space-y-8 bg-[#e5e2e1] p-6 sm:p-8 lg:p-12">
              <div className="space-y-4">
                ...
                <h4 className={`${previewHeadlineFont.className} text-2xl font-bold sm:text-3xl`}>
                  Endereco de Entrega
                </h4>
              ...
              <div className="space-y-5 border-t border-black/10 pt-8">
                ...
                <div className="flex items-center justify-between gap-4 border-t border-black/10 pt-4">
                  ...
                  <span className={`${previewHeadlineFont.className} text-3xl font-bold`}>
                    R$ 2.450,00
                  </span>
                </div>
              </div>
            ...
            <section className="space-y-5 bg-stone-100 p-6 text-center sm:p-8 lg:p-12">
              <h5 className={`${previewHeadlineFont.className} text-xl italic sm:text-2xl`}>
            ...
            <Link href={getBelapopHref(mode, "home")} className="group relative block overflow-hidden">
              <img
