...
const iconMap: Record<AdmIconKey, ReactNode> = {
  ...
  "brain-circuit":     <BrainCircuit className={iconClassName} />,
  "shield-alert":      <ShieldAlert className={iconClassName} />,
  "arrow-right-left":  <ArrowRightLeft className={iconClassName} />,
  "rotate-ccw":        <RotateCcw className={iconClassName} />,
  "clipboard-list":    <ClipboardList className={iconClassName} />,
  "pie-chart":         <PieChart className={iconClassName} />,
  "user-cog":          <UserCog className={iconClassName} />,
  "sliders-horizontal":<SlidersHorizontal className={iconClassName} />,
  history:             <History className={iconClassName} />,
  "file-text":         <FileText className={iconClassName} />,
  scale:               <Scale className={iconClassName} />,
  "bar-chart-2":       <BarChart2 className={iconClassName} />,
  layout:              <Layout className={iconClassName} />,
  "trending-up":       <TrendingUp className={iconClassName} />,
};
